...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pandablocks-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13218&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pandablocks-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pandablocks` can be installed with:

```
conda install pandablocks
```

It is possible to list all of the versions of `pandablocks` available on your platform with:
